...
import { SignupSchema } from "@metaverse/shared/schema";
      ...
      <div className="relative mt-20 grid w-full max-w-6xl overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl lg:grid-cols-2">
        <div className="flex flex-col justify-center p-8 md:p-12">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-400 md:text-base">
            Create an account to explore multiplayer rooms, communicate in real
            time and interact inside the metaverse environment.
          </p>
        ...
        <div className="relative hidden overflow-hidden lg:flex">
          ...
          <div className="absolute bottom-10 left-10 z-20 max-w-md">
            ...
            <p className="mt-4 text-sm text-slate-300">
              Experience world chat, collaborative rooms, voice communication
              and AI-powered interactions inside a shared digital environment.
            </p>
          </div>
        </div>
      </div>
